"""
Cross-Dynamical PDE Benchmark and Diagnostic Evaluation Suite
=============================================================
Executes:
1. Balanced 240-model cross-PDE surrogate ensemble (N=60 per dynamical system:
   Heat, Wave, Advection-Diffusion, and Viscous Burgers).
2. Within-tier correlation and partial correlation analysis controlling for surrogate convergence.
3. Parameter-space error propagation: e(theta) -> Delta G(theta) -> Delta log L(theta) -> W_1.
4. Controlled bulk-vs-tail causal error localization sweep.
5. Dimensionless Bayesian Fidelity Ratio (BFR) sensitivity calibration.
