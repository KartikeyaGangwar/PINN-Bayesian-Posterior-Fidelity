...
4. 5-dimensional parametric thermal diffusion inverse problem validation (d=5)
   evaluating 100-direction Sliced Wasserstein distances and observational projection crossover.
"""
...
df_d5.to_csv(os.path.join(output_dir, "heat_d5_results.csv"), index=False)
...
print("\nStatistical and higher-dimensional evaluation complete.")
